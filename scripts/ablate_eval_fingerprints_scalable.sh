...
MODELS=(
  "FP_models/scalable/meta-llama-Llama-3.1-8B-Instruct_scalable"
  "FP_models/scalable/meta-llama-Llama-3.2-1B-Instruct_scalable"
  "FP_models/scalable/Qwen-Qwen2.5-3B-Instruct_scalable"
)
